 ...
 * #2
 *
 * Розробити функцію, яка використовує метод map масиву для створення нового масиву, в якому кожен елемент буде вдвічі
 * більшим за елементи вхідного масиву чисел.
*/
...
function DateCalculator(initialFullDate) {
  let currentDate = new Date(initialFullDate);
...
const dateCalculator = new DateCalculator('2023-02-26');
